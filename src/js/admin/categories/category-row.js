  ...
  render() {
    ...
    return (
      <tr className = 'content-row-data category-row-data'>
        ...
        <td className = 'category-row-name-data'><a href = {'/articles/category/' + this.props.id}>{this.props.name}</a></td>
        <td className = 'category-row-parent-data'>{this.props.parent}</td>
        <td className = 'category-row-descp-data'>{this.props.descp}</td>
        <td className = 'category-row-order-data'><input type='number' value={this.props.mainorder} onChange = {this.categoryOrderChange} onKeyDown = {this.categoryOrderKeyDown} /></td>
        <td className = 'category-row-articlecnt-data'>{this.props.articlecnt}</td>
