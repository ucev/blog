      ...
      if (this.props.type == 'dir') {
        ...
        opeArea = (
          <div id = "refact-detail-ope-area">
            ...
            <label id = "refact-detail-ope-order-label">展示顺序</label><input id = "refact-detail-ope-order-input" type = "number" ref = {(input) => { this.orderInput = input }} value = {this.props.order} onChange = {this.handleOrderChange} onKeyDown = {this.handleKeyDown} />
          </div>
        )
      }
      return (
